---
title: "Cómo Cultivar Tomillo Sin Ahogarlo a Base de Cuidados"
description: "Drenaje, sol y poda del tomillo, y por qué la forma más común de matarlo es regarlo y abonarlo."
date: "2026-08-30"
tags:
    - "herbs"
    - "thyme"
...
infographicTitle: "Cómo cultivar tomillo"
infographicImage: "/assets/blog/como-cultivar-tomillo-infographic.jpg"
imageAlt: "Cómo cultivar tomillo"
guideSteps:
    - icon: "sun-over-plant"
      label: "Pleno Sol"
      bullets:
          - "Quiere el sitio más caluroso"
          - "A la sombra se desparrama"
    - icon: "gritty-soil"
      label: "Drenaje Excelente"
      bullets:
          - "Añade grava a la tierra"
          - "La raíz mojada se pudre"
    - icon: "no-fertiliser"
      label: "No lo Abones"
      bullets:
          - "La tierra pobre da más sabor"
          - "La rica da brote blando"
    - icon: "dry-watering-can"
      label: "Riega Poco"
      bullets:
          - "Déjalo secar entre riegos"
          - "El exceso mata más que la sequía"
    - icon: "herb-in-terracotta-pot"
      label: "Ponlo en Alto"
      bullets:
          - "Maceta o borde de muro"
          - "Mantiene el cuello seco"
    - icon: "trimming-herb-dome"
      label: "Recorta Tras Florecer"
      bullets:
          - "Un repaso ligero lo mantiene denso"
          - "Nunca cortes madera pelada"
    - icon: "thyme-sprigs"
      label: "Cosecha Todo el Año"
      bullets:
          - "Perenne en inviernos suaves"
          - "Corta ramitas según necesites"
    - icon: "layering-stem"
      label: "Renueva Cada Pocos Años"
      bullets:
          - "El centro se hace leñoso"
          - "Acoda un tallo para renovarlo"
guideProTip:
  label: "Consejo"
