---
title: "Cómo Cultivar Cilantro Sin Que se Suba a Flor en Tres Semanas"
description: "Siembra, distancias y calendario del cilantro, y por qué la planta quiere florecer desde que germina."
date: "2026-08-30"
tags:
    - "herbs"
    - "cilantro"
...
infographicTitle: "Cómo cultivar cilantro"
infographicImage: "/assets/blog/como-cultivar-cilantro-infographic.jpg"
imageAlt: "Cómo cultivar cilantro"
guideSteps:
    - icon: "cilantro-plant"
      label: "Siembra en Fresco"
      bullets:
          - "Primavera y otoño son mejores"
          - "El calor lo sube a flor"
    ...
    - icon: "succession-sowing-rows"
      label: "Cada Tres Semanas"
      bullets:
          - "Toda planta acaba floreciendo"
          - "Mejor escalonar que insistir"
    - icon: "shade-cloth-bed"
      label: "Media Sombra"
      bullets:
          - "La sombra de tarde lo frena"
          - "Pleno sol vale en primavera"
    - icon: "watering-can-sprinkle"
      label: "Riego Constante"
      bullets:
          - "Secarse dispara la floración"
          - "Acolcha para retener humedad"
    - icon: "dense-sown-herb-patch"
      label: "Siembra Denso"
      bullets:
          - "Más denso que otras hierbas"
          - "Córtalo como hoja de ensalada"
    - icon: "picking-outer-leaves"
      label: "Corta de Fuera"
      bullets:
          - "Tallos enteros desde la base"
          - "Rebajar por arriba lo debilita"
    - icon: "coriander-seed-heads"
      label: "Deja Florecer"
      bullets:
          - "La flor alimenta sírfidos"
          - "Guarda la semilla de coriandro"
guideProTip:
  label: "Consejo"
