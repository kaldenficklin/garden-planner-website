---
title: "Cómo Cultivar Lavanda que Dure Año tras Año"
description: "Sol, drenaje muy bueno y la poda anual que decide si una planta dura tres años o diez."
date: "2026-08-23"
tags:
    - "flowers"
    - "lavender"
...
infographicTitle: "Cómo cultivar lavanda"
infographicImage: "/assets/blog/como-cultivar-lavanda-infographic.jpg"
imageAlt: "Cómo cultivar lavanda"
guideSteps:
    - icon: "lavender-plant"
      label: "Pleno Sol"
      bullets:
          - "De seis a ocho horas diarias"
          - "A la sombra da poca flor"
    - icon: "sun-over-plant"
      label: "Drenaje Muy Bueno"
      bullets:
          - "Añade grava si es arcilla"
          - "La raíz mojada en invierno mata"
    - icon: "gritty-soil"
      label: "Espacio para Ventilar"
      bullets:
          - "Deja hueco entre plantas"
          - "El aire húmedo la pudre"
    - icon: "spaced-plants-row"
      label: "Riega solo al Arraigar"
      bullets:
          - "Riega el primer año"
          - "Después déjala tranquila"
    ...
    - icon: "compost-and-feed"
      label: "Poda Cada Año"
      bullets:
          - "Recorta tras la floración"
          - "Evita que se abra por dentro"
    - icon: "pruning-shears-tomato"
      label: "Nunca en Madera Vieja"
      bullets:
          - "Corta sobre hoja verde"
          - "La madera vieja no rebrota"
    - icon: "lavender-bundle"
      label: "Corta para Aroma"
      bullets:
          - "Corta al colorear el botón"
          - "Más aroma antes de abrir"
guideProTip:
  label: "Consejo"
