---
title: "Cómo Construir un Bancal Elevado al que de Verdad Llegues"
description: "Ancho, profundidad, madera y mezcla de tierra, con la regla de tamaño que decide si acabas pisando el suelo."
date: "2026-08-24"
tags:
    - "raised-beds"
    - "beginners"
...
infographicTitle: "Cómo construir un bancal"
infographicImage: "/assets/blog/como-construir-un-bancal-elevado-infographic.jpg"
imageAlt: "Cómo construir un bancal"
guideSteps:
    - icon: "sun-over-plant"
      label: "Elige Pleno Sol"
      bullets:
          - "Seis horas o más al día"
          - "Casi todo quiere sol"
    - icon: "raised-bed-frame"
      label: "Metro Veinte de Ancho"
      bullets:
          - "Llega al centro desde los lados"
          - "Nunca pises la tierra"
    - icon: "bed-depth-cross-section"
      label: "Suficiente Profundidad"
      bullets:
          - "Treinta centímetros mínimo"
          - "La raíz necesita hondura"
    - icon: "cedar-boards"
      label: "Madera sin Tratar"
      bullets:
          - "El cedro o alerce duran"
          - "Evita traviesas tratadas"
    - icon: "level-ground"
      label: "Nivela el Suelo"
      bullets:
          - "Nivela antes de rellenar"
          - "En pendiente drena mal"
    - icon: "cardboard-lining"
      label: "Forra la Base"
      bullets:
          - "El cartón ahoga la hierba"
          - "Deja la base drenando"
    - icon: "soil-mix"
      label: "Rellena con Mezcla"
      bullets:
          - "Compost con tierra vegetal"
          - "La tierra sola se compacta"
    - icon: "compost-and-feed"
      label: "Rellena Cada Año"
      bullets:
          - "La tierra baja al descomponerse"
          - "Añade compost en primavera"
guideProTip:
  label: "Consejo"
