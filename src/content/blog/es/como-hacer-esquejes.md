---
title: "Cómo Convertir Una Planta en Una Docena Gratis"
description: "Dónde cortar, cuándo tomarlos y las condiciones que deciden si un esqueje enraíza o se pudre."
date: "2026-09-04"
tags:
    - "propagation"
    - "cuttings"
...
infographicTitle: "Cómo hacer esquejes"
infographicImage: "/assets/blog/como-hacer-esquejes-infographic.jpg"
imageAlt: "Cómo hacer esquejes"
guideSteps:
    - icon: "soft-shoot-tip"
      label: "Brote Tierno"
      bullets:
          - "El brote de verano enraíza mejor"
          - "Evita el tallo leñoso"
    - icon: "flower-bud-crossed"
      label: "Sin Flores"
      bullets:
          - "El brote con flor enraíza mal"
          - "Elige una punta solo con hoja"
    - icon: "cutting-below-node"
      label: "Corta Bajo el Nudo"
      bullets:
          - "Justo debajo de un nudo"
          - "Ahí están las hormonas"
    - icon: "stripped-cutting"
      label: "Quita Hojas Bajas"
      bullets:
          - "La hoja enterrada se pudre"
          - "Deja dos o tres arriba"
    - icon: "gritty-compost-pot"
      label: "Sustrato con Arena"
      bullets:
          - "El drenaje evita la podredumbre"
          - "Añade arena o perlita"
    - icon: "bag-over-pot"
      label: "Mantén la Humedad"
      bullets:
          - "Una bolsa transparente ayuda"
          - "Todavía no tiene raíces"
    - icon: "bright-shade-windowsill"
      label: "Luz Sin Sol Directo"
      bullets:
          - "El sol directo los cuece"
          - "Sombra luminosa es ideal"
    - icon: "rooted-cutting"
      label: "Tira Suave"
      bullets:
          - "Si resiste, hay raíces"
          - "Trasplanta al enraizar"
guideProTip:
  label: "Consejo"
