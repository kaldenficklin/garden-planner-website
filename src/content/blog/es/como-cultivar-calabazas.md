---
title: "Cómo Cultivar Calabazas Que Valga la Pena Cargar"
description: "Distancias, abonado y polinización de la calabaza, y el truco que evita que se pudra por abajo."
date: "2026-08-27"
tags:
    - "pumpkins"
    - "vegetables"
...
infographicTitle: "Cómo cultivar calabazas"
infographicImage: "/assets/blog/como-cultivar-calabazas-infographic.jpg"
imageAlt: "Cómo cultivar calabazas"
guideSteps:
    - icon: "pumpkin-seedling"
      label: "Espera al Calor"
      bullets:
          - "Siembra pasada la última helada"
          - "La tierra fría pudre la semilla"
    - icon: "sprawling-vine"
      label: "Dales Sitio"
      bullets:
          - "Las guías se extienden mucho"
          - "Deja varios metros por planta"
    - icon: "soil-mix"
      label: "Abona la Tierra"
      bullets:
          - "Planta con bastante compost"
          - "Son muy exigentes"
    - icon: "watering-can-sprinkle"
      label: "Riega la Base"
      bullets:
          - "Riega el pie, no la hoja"
          - "La hoja mojada coge oídio"
    - icon: "hand-pollinating"
      label: "Ayuda a Polinizar"
      bullets:
          - "Poliniza a mano por la mañana"
          - "Las flores macho abren antes"
    - icon: "pumpkin-on-vine"
      label: "Aclara los Frutos"
      bullets:
          - "Deja dos o tres por mata"
          - "Menos frutos crecen más"
    - icon: "pumpkin-on-board"
      label: "Súbelas del Suelo"
      bullets:
          - "Apoya el fruto en una tabla"
          - "Evita que se pudra abajo"
    - icon: "cured-pumpkins"
      label: "Cura la Piel"
      bullets:
          - "Corta dejando un trozo de tallo"
          - "Cura al sol para endurecer"
guideProTip:
  label: "Consejo"
