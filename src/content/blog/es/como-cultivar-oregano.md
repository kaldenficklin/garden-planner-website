---
title: "Cómo Cultivar Orégano Que de Verdad Sepa a Algo"
description: "Sol, tierra y corte del orégano, y el momento que decide si sabe fuerte o no sabe a nada."
date: "2026-08-31"
tags:
    - "herbs"
    - "oregano"
...
infographicTitle: "Cómo cultivar orégano"
infographicImage: "/assets/blog/como-cultivar-oregano-infographic.jpg"
imageAlt: "Cómo cultivar orégano"
guideSteps:
    - icon: "sun-over-plant"
      label: "Pleno Sol"
      bullets:
          - "El sol concentra el sabor"
          - "A la sombra queda soso"
    - icon: "gritty-soil"
      label: "Tierra Pobre y Seca"
      bullets:
          - "El drenaje es imprescindible"
          - "La tierra rica le quita sabor"
    - icon: "no-fertiliser"
      label: "Nada de Abono"
      bullets:
          - "Abonar da brote blando"
          - "Con hambre sabe más fuerte"
    ...
    - icon: "oregano-buds"
      label: "Corta Antes de Florecer"
      bullets:
          - "El sabor cumbre en botón"
          - "Corta tallos, no hojas sueltas"
    - icon: "cutting-herb-stems"
      label: "Corta a Fondo"
      bullets:
          - "Puedes llevarte media planta"
          - "Rebrota rápido en verano"
    - icon: "drying-herb-bunch"
      label: "Seca lo que Sobre"
      bullets:
          - "Se seca mejor que otras hierbas"
          - "Cuelga manojos pequeños"
    - icon: "dividing-plant"
      label: "Divide Cada Pocos Años"
      bullets:
          - "La mata se hace leñosa"
          - "Divide en primavera"
guideProTip:
  label: "Consejo"
