---
title: "Cómo Cultivar Romero: Casi Todo el Mundo lo Riega de Más"
description: "Drenaje, sol y contención. El romero muere de exceso de cuidado más que de abandono."
date: "2026-08-23"
tags:
    - "herbs"
    - "rosemary"
...
infographicTitle: "Cómo cultivar romero"
infographicImage: "/assets/blog/como-cultivar-romero-infographic.jpg"
imageAlt: "Cómo cultivar romero"
guideSteps:
    - icon: "rosemary-sprig"
      label: "Pleno Sol"
      bullets:
          - "Seis horas o más al día"
          - "A la sombra sale ralo"
    - icon: "sun-over-plant"
      label: "Tierra con Grava"
      bullets:
          - "Añade arena o grava"
          - "Odia estar encharcado"
    - icon: "gritty-soil"
      label: "Maceta de Barro"
      bullets:
          - "El barro seca antes"
    ...
    - icon: "pot-with-drainage"
      label: "Riega Poco"
      bullets:
          - "Solo si está bien seco"
          - "El exceso es lo que lo mata"
    - icon: "watering-can-sprinkle"
      label: "Sin Abono Rico"
      bullets:
          - "En tierra pobre huele más"
          - "El abono da brote blando"
    - icon: "compost-and-feed"
      label: "Poda tras Florecer"
      bullets:
          - "Dale forma una vez al año"
          - "Nunca cortes en madera vieja"
    - icon: "pruning-shears-tomato"
      label: "Protege del Hielo"
      bullets:
          - "Arrima la maceta a un muro"
          - "El frío húmedo es lo peor"
    - icon: "rosemary-harvest"
      label: "Corta Todo el Año"
      bullets:
          - "Corta las puntas tiernas"
          - "Más aroma antes de florecer"
guideProTip:
  label: "Consejo"
