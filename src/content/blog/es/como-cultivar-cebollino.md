---
title: "Cómo Cultivar Cebollino Que Vuelva Cada Año"
description: "Plantar, cortar y dividir cebollino, y la forma de cosechar que lo mantiene tierno en vez de duro."
date: "2026-08-28"
tags:
    - "herbs"
    - "chives"
...
infographicTitle: "Cómo cultivar cebollino"
infographicImage: "/assets/blog/como-cultivar-cebollino-infographic.jpg"
imageAlt: "Cómo cultivar cebollino"
guideSteps:
    - icon: "sun-over-plant"
      label: "Pleno Sol"
      bullets:
          - "Seis horas lo mantienen erguido"
          - "A la sombra se tumba"
    - icon: "soil-mix"
      label: "Tierra Normal"
      bullets:
          - "No necesita abonado rico"
          - "Importa más el drenaje"
    - icon: "chive-clump"
      label: "Empieza con Mata"
      bullets:
          - "La semilla tarda mucho"
          - "Sirve una maceta del súper"
    - icon: "watering-can-sprinkle"
      label: "Riega en Sequía"
      bullets:
          - "Se resiente con la sequía"
          - "El acolchado retiene humedad"
    - icon: "cutting-chives-low"
      label: "Corta Bajo"
      bullets:
          - "Tallos enteros desde la base"
          - "Despuntar deja tocones duros"
    - icon: "chive-flowers"
      label: "Deja Alguna Flor"
      bullets:
          - "La flor morada se come"
          - "Corta el resto para hoja"
    - icon: "dividing-plant"
      label: "Divide Cada Pocos Años"
      bullets:
          - "La mata se ahoga a sí misma"
          - "Divide en primavera u otoño"
    - icon: "cut-back-clump"
      label: "Poda en Otoño"
      bullets:
          - "Corta bajo cuando se seque"
          - "Rebrota desde la raíz"
guideProTip:
  label: "Consejo"
