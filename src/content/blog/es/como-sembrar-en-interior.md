---
title: "Cómo Sembrar en Interior sin que las Plántulas se Estiren"
description: "Calendario, luz y la semana de aclimatación que casi todo el mundo se salta y que le cuesta las plántulas."
date: "2026-08-24"
tags:
    - "seed-starting"
    - "beginners"
...
infographicTitle: "Cómo sembrar en interior"
infographicImage: "/assets/blog/como-sembrar-en-interior-infographic.jpg"
imageAlt: "Cómo sembrar en interior"
guideSteps:
    - icon: "frost-calendar"
      label: "Cuenta desde la Helada"
      bullets:
          - "Calcula desde la última helada"
          - "Cada cultivo lleva su plazo"
    - icon: "seed-tray-indoors"
      label: "Sustrato de Semillero"
      bullets:
          - "Fino y con pocos nutrientes"
          - "La tierra del jardín trae hongos"
    - icon: "seed-sowing-depth"
      label: "Profundidad Correcta"
      bullets:
          - "Unas dos veces el grosor"
          - "Muy hondo y no sale"
    - icon: "warm-propagator"
      label: "Mantenlas Calientes"
      bullets:
          - "El calor es para germinar"
          - "Luego pásalas a sitio fresco"
    - icon: "grow-light-seedlings"
      label: "Luz Fuerte"
      bullets:
          - "La luz a pocos centímetros"
          - "En la ventana se estiran"
    - icon: "bottom-watering-tray"
      label: "Riega por Abajo"
      bullets:
          - "Pon la bandeja en agua"
          - "Regar arriba las tumba"
    - icon: "potting-on-seedling"
      label: "Trasplanta al Apretarse"
      bullets:
          - "Cambia al salir hoja verdadera"
          - "La raíz necesita sitio"
    - icon: "hardening-off"
      label: "Aclimata una Semana"
      bullets:
          - "Más rato fuera cada día"
          - "Saltarse esto cuesta plantas"
guideProTip:
  label: "Consejo"
