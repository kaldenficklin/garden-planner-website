---
title: "Por Qué Tu Montón de Compost Está Frío, Baboso y Parado"
description: "El equilibrio, la humedad y el volteo que deciden si un montón se descompone en meses o se queda ahí años."
date: "2026-09-01"
tags:
    - "compost"
    - "soil"
...
infographicTitle: "Cómo hacer compost"
infographicImage: "/assets/blog/como-hacer-compost-infographic.jpg"
imageAlt: "Cómo hacer compost"
guideSteps:
    - icon: "dry-brown-leaves"
      label: "Dos Partes Marrón"
      bullets:
          - "Dos marrones por un verde"
          - "El marrón es seco y carbonado"
    - icon: "kitchen-scraps-bucket"
      label: "El Verde da Nitrógeno"
      bullets:
          - "Restos de cocina y siega"
          - "Es la mitad húmeda"
    - icon: "compost-bin-full"
      label: "Hazlo Grande"
      bullets:
          - "Un metro cúbico retiene calor"
          - "Los pequeños no calientan"
    - icon: "squeezing-damp-compost"
      label: "Húmedo, No Mojado"
      bullets:
          - "Como una esponja escurrida"
          - "Tápalo si llueve mucho"
    - icon: "chopped-prunings"
      label: "Trocea Más Fino"
      bullets:
          - "Lo pequeño se pudre antes"
          - "Parte los tallos leñosos"
    - icon: "turning-compost-fork"
      label: "Voltea al Enfriarse"
      bullets:
          - "Voltear airea y mezcla"
          - "Vuelve a calentar después"
    - icon: "compost-no-meat"
      label: "Deja Cosas Fuera"
      bullets:
          - "Ni carne, lácteos ni aceite"
          - "Evita hierbas con semilla"
    - icon: "finished-compost-crumb"
      label: "Espera al Marrón Suelto"
      bullets:
          - "El compost hecho huele a tierra"
          - "Criba los trozos grandes"
guideProTip:
  label: "Consejo"
