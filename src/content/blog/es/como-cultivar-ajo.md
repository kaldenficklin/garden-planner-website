---
title: "Cómo Cultivar Ajo a Partir de una Sola Cabeza"
description: "Cuándo plantar, a qué profundidad y la señal en las hojas que indica que ya puedes arrancarlo."
date: "2026-08-25"
tags:
    - "garlic"
    - "vegetables"
...
infographicTitle: "Cómo cultivar ajo"
infographicImage: "/assets/blog/como-cultivar-ajo-infographic.jpg"
imageAlt: "Cómo cultivar ajo"
guideSteps:
    - icon: "garlic-bulb"
      label: "Planta en Otoño"
      bullets:
          - "Antes de que hiele el suelo"
          - "El frío activa la formación"
    - icon: "garlic-cloves-split"
      label: "Separa la Cabeza"
      bullets:
          - "Separa los dientes al plantar"
          - "Planta los más grandes"
    - icon: "planting-clove-depth"
      label: "Punta Hacia Arriba"
      bullets:
          - "La base plana va abajo"
          - "Unos centímetros bajo tierra"
    - icon: "spaced-plants-row"
      label: "Marca la Distancia"
      bullets:
          - "Quince centímetros entre dientes"
          - "Apretados dan cabezas pequeñas"
    - icon: "straw-mulch-bed"
      label: "Acolcha en Invierno"
      bullets:
          - "La paja estabiliza la temperatura"
          - "Retírala en primavera"
    - icon: "compost-and-feed"
      label: "Abona en Primavera"
      bullets:
          - "Nitrógeno mientras crecen las hojas"
          - "Deja de abonar al final"
    - icon: "garlic-scape"
      label: "Corta los Escapos"
      bullets:
          - "El cuello duro echa escapos"
          - "Cortarlos engorda la cabeza"
    - icon: "curing-garlic"
      label: "Arranca al Amarillear"
      bullets:
          - "Hojas bajas secas, puntas verdes"
          - "Cura en sitio seco y aireado"
guideProTip:
  label: "Consejo"
