---
title: "Por Qué Tus Plántulas se Estiran y se Caen"
description: "Qué provoca las plántulas pálidas y estiradas en una ventana, cómo evitarlo y cuáles todavía se pueden salvar."
date: "2026-09-03"
tags:
    - "seed-starting"
    - "seedlings"
...
infographicTitle: "Cómo evitar plántulas estiradas"
infographicImage: "/assets/blog/por-que-las-plantulas-se-estiran-infographic.jpg"
imageAlt: "Cómo evitar plántulas estiradas"
guideSteps:
    - icon: "leggy-seedling"
      label: "Es la Luz"
      bullets:
          - "Estirarse es buscar luz"
          - "Una ventana clara es poca luz"
    - icon: "grow-light-close"
      label: "Acerca la Luz"
      bullets:
          - "A pocos centímetros de la hoja"
          - "La distancia la debilita mucho"
    - icon: "seedling-leaning-window"
      label: "Gíralas a Diario"
      bullets:
          - "Se inclinan hacia la ventana"
          - "Girarlas las mantiene rectas"
    - icon: "thermometer-cool"
      label: "Baja el Calor"
      bullets:
          - "Calor sin luz estira"
          - "Llévalas a un sitio fresco"
    - icon: "crowded-seed-tray"
      label: "Siembra Menos"
      bullets:
          - "Apretadas se dan sombra"
          - "Aclara pronto y sin pena"
    - icon: "hand-brushing-seedlings"
      label: "Acaríciales las Puntas"
      bullets:
          - "Pasa la mano por encima"
          - "El movimiento engrosa el tallo"
    - icon: "deep-planted-seedling"
      label: "Entierra el Tomate"
      bullets:
          - "Enraíza a lo largo del tallo"
          - "Planta hondo para arreglarlo"
    - icon: "seed-packet-resow"
      label: "Resiembra si Hace Falta"
      bullets:
          - "Mejor resembrar que insistir"
          - "Las siembras tardías alcanzan"
guideProTip:
  label: "Consejo"
