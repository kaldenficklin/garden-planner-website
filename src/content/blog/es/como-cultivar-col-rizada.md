---
title: "Cómo Cultivar Col Rizada Que Aguante Todo el Invierno"
description: "Siembra, distancias y mallas para la col rizada, y por qué la primera helada mejora su sabor."
date: "2026-08-27"
tags:
    - "kale"
    - "vegetables"
...
infographicTitle: "Cómo cultivar col rizada"
infographicImage: "/assets/blog/como-cultivar-col-rizada-infographic.jpg"
imageAlt: "Cómo cultivar col rizada"
guideSteps:
    - icon: "kale-plant"
      label: "Siembra en Verano"
      bullets:
          - "A principios de verano para otoño"
          - "Aguanta todo el invierno"
    - icon: "soil-mix"
      label: "Tierra Firme y Rica"
      bullets:
          - "Quiere suelo bien asentado"
          - "Añade bastante compost"
    - icon: "deep-planted-seedling"
      label: "Planta Hondo"
      bullets:
          - "Entierra hasta las primeras hojas"
          - "Así el tallo va firme"
    - icon: "spaced-plants-row"
      label: "Deja Espacio"
      bullets:
          - "Cada planta necesita sitio"
          - "Apretadas cogen oídio"
    - icon: "brassica-netting"
      label: "Pon Malla"
      bullets:
          - "La malla fina para la mariposa"
          - "Mira los huevos bajo la hoja"
    - icon: "mulched-plant"
      label: "Riega en Sequía"
      bullets:
          - "El riego mantiene la hoja tierna"
          - "Acolcha para retener humedad"
    - icon: "frosted-kale-leaf"
      label: "Déjala Helarse"
      bullets:
          - "El frío convierte almidón en azúcar"
          - "Recoge tras la primera helada"
    - icon: "picking-outer-leaves"
      label: "Corta las de Abajo"
      bullets:
          - "Recoge primero las hojas bajas"
          - "El cogollo sigue produciendo"
guideProTip:
  label: "Consejo"
